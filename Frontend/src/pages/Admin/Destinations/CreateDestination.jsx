...
const CreateDestination = () => {
    ...
    useEffect(() => {
        const fetchLocations = async () => {
            try {
                const response = await fetch("http://localhost:8001/api/location/location");
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append("locationId", state); // Append locationId here
        ...
        try {
            ...
            if (response.ok) {
                ...
                // After successful submission, navigate to destination list
                navigate("/destination"); // Navigate to the destination list page
            } else {
                        ...
                        >
                            ...
                            {locations.map((location) => (
                                <option key={location._id} value={location._id}>
                                    {location.firstname} {/* Ensure this property exists */}
                                </option>
                            ))}
                        </select>
                    </div>
